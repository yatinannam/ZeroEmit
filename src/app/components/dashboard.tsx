...
export function Dashboard() {
  ...
  return <div className="mobile-app">
    ...
    <main className="dashboard-content">
      <section className="greeting"><button className="location-label location-button" onClick={openLocation}><Icon name="pin" size={16}/> {location}</button><h1>Good morning</h1></section>
